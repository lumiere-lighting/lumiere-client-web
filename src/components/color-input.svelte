<script>
  ...
  function suggestionSelectedDown() {
    ...
    suggestionSelected =
      suggestionSelected === null ? 0 :
        suggestionSelected === suggestions.length - 1 ? 0 :
  ...
  function suggestionSelectedUp() {
    ...
    suggestionSelected =
      suggestionSelected === null ? suggestions.length - 1 :
        suggestionSelected === 0 ? suggestions.length - 1 :
          suggestionSelected - 1;
  }
...
>
  ...
  {#if hasSuggestions}
    <aside id="{id}-suggestions" class="suggestions" role="listbox">
            ...
            <ul class="swatches">
              {#each suggestion.colors as color}
                <li
                  ...
                  style:border-color={color === '#FFFFFF' ? '#E1E1E1' : chroma(color).brighten(0.5).css()}>
                </li>
              {/each}
            </ul>
          </li>
